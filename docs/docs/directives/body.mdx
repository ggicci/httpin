...
**body** is a [directive](/advanced/concepts#directives) who decodes a field from the body of the request, i.e. [`http.Request.Body`](https://pkg.go.dev/net/http#Request), **JSON** and **XML** formats are supported.
